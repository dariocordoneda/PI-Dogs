...
export default function Home() {
  ...
  //es lo mismo que hacer mapstatetoprop, con use selector traeme todo lo que esta en el estado de dogs,todo en esta constante,trabajo todo desde ahi
  ...
  //el slice me corta un arreglo,donde yo le especifique donde,toma una porcion donde yo le indique por parametro. la logica es agarrar el indice del primer dog y el indice del ultimo.
  const [, /*orden*/ setOrden] = useState("");
  const paginado = (pageNumber) => {
    //le paso un numero de la pagina y voy a setear la pag en ese numero de pagina
  ...
  useEffect(() => {
    //traemos del estado los dogs cuando el componenet se monta
  ...
  function handleClick(e) {
    //al boton refresh le paso una funcion,para manejar el boton
  ...
  function handleFilterTemperaments(e) {
    //un handle del filter del temperam, siempre poner nombre acorde
  ...
  return (
    //aqui renderizamos,con un div que envuelva todo
    <div>
      {currentDogs.length > 0 ? (
        <div className="home">
          <div className="logo-container">
            <h1 className="logo-name">DoggyPedia</h1>
          </div>
          ...
          <div className="divNB">
            <ul className="navbar">
              <li className="content-select">
                ...
                >
                  <option defaultValue="all">ALL DOGS</option>
